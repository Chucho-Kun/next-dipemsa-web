...
export const productos: ProductosType[] = [
  ...
  { name: "sistemas-de-fijacion-convencional", src: "/productos/sistemas-de-fijacion-convencional.jpg" },
  { name: "compuestos-y-cintas", src: "/productos/compuestos-y-cintas.jpg" },
  { name: "cempanel", src: "/productos/cempanel.jpg" },
  { name: "tornilleria", src: "/productos/tornilleria.jpg" },
  ...
  { name: "suspension", src: "/productos/suspension.jpg" },
